...
inventory tracker that was used as a data dump for when the new system
arrived.
...
represented an ongoing project of mine to streamline the system. It tracks
expiration dates, is very sortable, and produces various reports on the patron
activity, allowing for observations trends or for pulling specific statistics.
